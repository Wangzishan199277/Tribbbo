package com.example.wangzishan.tribbbo.dribbble;
...
import com.example.wangzishan.tribbbo.model.User;
...
public class Dribbble {
    ...
    private static Response makeGetResponse(String url) throws IOException{
    ...
    public static User getUser() throws IOException, JsonSyntaxException{
        return parseResponse(makeGetResponse(USER_END_POINT), USER_TYPE);
    }
