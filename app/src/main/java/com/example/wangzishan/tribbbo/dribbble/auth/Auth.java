package com.example.wangzishan.tribbbo.dribbble.auth;
...
public class Auth {
    ...
    private static final String CLIENT_ID ="a565100e9b90e9e7ea237320157a069bee51edafd1a2f74f09b8260008331263";

    private static final String CLIENT_SECRET = "8f2d042f61ca580a6706ad6b6d3ecb7a969d8627074f3e7af532dfab21e518d6";
    ...
    private static String getAuthorizeUrl(){
        String url = Uri.parse(URI_AUTHORIZE).buildUpon().appendQueryParameter(KEY_CLIENT_ID,CLIENT_ID).build().toString();
